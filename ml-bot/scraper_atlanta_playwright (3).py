...
# Seletores de título — do mais específico ao mais genérico
TITULO_SELETORES = [
    # Layouts poly (2024+)
    "h2.poly-box",
    ...
    # Link principal do card (quase sempre tem o título no texto)
    "a.poly-component__title",
    "a[class*='ui-search-link__title-card']",
    "a[class*='ui-search-link']",
    # Fallback: qualquer h2 ou h3 dentro do card
    "h2",
    "h3",
]
...
def extrair_titulo(card) -> str:
    """Tenta seletores em ordem; como último recurso usa o texto do link principal."""
    ...
    # Último recurso: texto do primeiro <a> do card (geralmente é o título)
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for pagina in range(1, MAX_PAGINAS + 1):
            ...
            # Diagnóstico: mostra o título do primeiro produto da página
            print(f"  🔎 Exemplo título: {produtos[0]['titulo']}")
